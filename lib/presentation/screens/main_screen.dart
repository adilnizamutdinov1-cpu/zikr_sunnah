...
class _MainScreenState extends ConsumerState<MainScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: activeZikrAsync.when(
        ...
        data: (zikr) => zikr != null 
          ? _buildCounterScreen(context, zikr, settings, l)
              ...
              children: [
                ...
                ZikrHeader(
                  ...
                  warningText: showWarning 
                    ? l.warningThreshold.replaceAll('{count}', zikr.remainingToTarget.toString())
                    : null,
  ...
  Widget _buildUndoOverlay(BuildContext context, AppLocalizations l) {
    final theme = Theme.of(context);
    return Positioned(
      bottom: 100,
      left: 16,
  ...
  void _onSwipe(BuildContext context, DragEndDetails details, AppLocalizations l) {
  ...
  void _showQuickActions(BuildContext context, Zikr zikr, AppLocalizations l) {
    if (ref.read(settingsProvider).hapticsEnabled) {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => _QuickActionsSheet(zikr: zikr, l: l),
    );
  }
  ...
  void _undoReset(BuildContext context) {
    if (_lastResetSession != null) {
      ref.read(counterProvider(_lastResetSession!.zikrId).notifier)
        .setCount(_lastResetSession!.previousCount);
      setState(() => _lastResetSession = null);
    }
  }
...
class _QuickActionsSheet extends ConsumerWidget {
  ...
  const _QuickActionsSheet({required this.zikr, required this.l});
          ...
          child: Column(
            ...
            children: [
              ...
              _ActionButton(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _showExactNumberDialog(context, ref, zikr, l);
                },
                color: cs.primary,
              ...
              _ActionButton(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _showResetConfirmation(context, ref, zikr, l);
                },
                color: cs.error,
                isDestructive: true,
  ...
  void _showExactNumberDialog(BuildContext context, WidgetRef ref, Zikr zikr, AppLocalizations l) {
    final controller = TextEditingController(text: zikr.currentCount.toString());
    
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(l.enterExactNumber),
        content: TextField(
          controller: controller,
          keyboardType: TextInputType.number,
          autofocus: true,
          decoration: InputDecoration(
            hintText: l.enterExactNumber,
          ),
        ),
        actions: [
          TextButton(
  ...
  void _showResetConfirmation(BuildContext context, WidgetRef ref, Zikr zikr, AppLocalizations l) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(l.resetConfirmation),
        content: Text(l.resetConfirmationMessage),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(l.cancel),
